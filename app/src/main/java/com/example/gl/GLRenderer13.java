...
public class GLRenderer13 implements GLSurfaceView.Renderer {
    ...
    // 第一人称漫游控制
    private final float[] fpvPosition = {0.0f, 5.0f, 0.0f}; // 第一人称位置
    ...
    public GLRenderer13(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        // 加载着色器
        String vertexShader = ShaderUtils.loadShader(context, R.raw.vertex_shader2);
        String fragmentShader = ShaderUtils.loadShader(context, R.raw.fragment_shader2);
