    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Log.d("SKDEBUG", "调用 recalculateNormals() 前:");
                Log.d("SKDEBUG", "vertexCount: " + TIFFParseResultData.meshData3.vertexCount);
                Log.d("SKDEBUG", "indexCount: " + TIFFParseResultData.meshData3.indexCount);
                Log.d("SKDEBUG", "vertices.capacity: " + TIFFParseResultData.meshData3.vertices.capacity());
